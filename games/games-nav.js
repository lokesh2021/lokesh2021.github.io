...
(function() {
    ...
    // Determine current game for highlighting
    const games = [
        { path: 'memory', name: 'Memory Match', emoji: '🧠', href: '../memory/index.html' },
        { path: 'snake', name: 'Snake', emoji: '🐍', href: '../snake/index.html' },
        { path: '2048', name: '2048', emoji: '🔢', href: '../2048/index.html' },
        { path: 'aim-trainer', name: 'Aim Trainer', emoji: '🎯', href: '../aim-trainer/index.html' },
        { path: 'typing-test', name: 'Typing Test', emoji: '⌨️', href: '../typing-test/index.html' },
        { path: 'reaction', name: 'Reaction Time', emoji: '⚡', href: '../reaction/index.html' },
